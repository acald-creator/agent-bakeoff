 ...
 *
 * SPLIT STORAGE: Index (metadata) and body (full content) stored separately.
 *   - Index ("ink:index"): sidebar hydration, ~150 bytes/note
 *   - Bodies ("ink:note:<id>"): loaded on demand when opening a note
 *
 * Silent failure on quota errors; app continues in-memory.
 */
