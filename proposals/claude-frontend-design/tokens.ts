...
export const tokens = createGlobalTheme(':root', {
  ...
  motion: {
    // All durations in ms as strings for use in CSS calc()
    durationFast:   '120ms',
 ...
 * The preload hints below should be placed in <head> before any render:
 *
 ...
 *     &family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;1,9..40,400
 *     &family=Fira+Code:wght@400;500
 *     &display=swap">
 *
 * Total font weight (all four families, subset latin): ~150 KB compressed.
 * Excluded from bundle size per brief methodology.
 */
